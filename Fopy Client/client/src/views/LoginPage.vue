    ...
    <div class="container px-6 mx-auto">
      ...
      >
        <div class="flex flex-col w-full">
          ...
          <h1 class="text-5xl text-gray-800 font-bold">Fopy - Client Area</h1>
          <p class="mx-auto md:mx-0 text-gray-500">
            Control and monitorize your Fopy data from our dashboard.
          </p>
        </div>
        <div class="w-full md:w-full lg:w-9/12 mx-auto md:mx-0">
          <div class="bg-white p-10 flex flex-col w-full shadow-xl rounded-xl">
            ...
            <form @submit.prevent="LoginForm" class="w-full">
              ...
              <div id="button" class="flex flex-col w-full my-5">
                <button
                  type="submit"
                  class="w-full py-4 bg-blue-600 rounded-lg text-blue-100"
                >
